...
class HubertModel(BaseFairseqModel):
    ...
    def forward(
        ...
        layer_norm_before_shared : int = -1,
        mode = None
        ...
        result = {"x": x, "padding_mask": padding_mask, "features": features, "layer_results": layer_results, "mask_indices": mask_indices,
                    "target_list": target_list, "features_pen": features_pen}
